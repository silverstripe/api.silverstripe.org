...
nice $APIGEN_BIN --config conf/apigen/apigen.neon --source src/master --destination htdocs/master --title "SilverStripe master API Docs"
...
nice $APIGEN_BIN --config conf/apigen/apigen.neon --source src/3.1 --destination htdocs/3.1 --title "SilverStripe 3.1 API Docs"
...
nice $APIGEN_BIN --config conf/apigen/apigen.neon --source src/3.0 --destination htdocs/3.0 --title "SilverStripe 3.0 API Docs"
...
nice $APIGEN_BIN --config conf/apigen/apigen.neon --source src/2.4 --destination htdocs/2.4 --title "SilverStripe 2.4 API Docs"
...
nice $APIGEN_BIN --config conf/apigen/apigen.neon --source src/modules/blog/master --destination htdocs/modules/blog/master --title "SilverStripe blog module trunk API Docs"
...
nice $APIGEN_BIN --config conf/apigen/apigen.neon --source src/modules/cmsworkflow/master --destination htdocs/modules/cmsworkflow/master --title "SilverStripe cmsworkflow module trunk API Docs"
...
nice $APIGEN_BIN --config conf/apigen/apigen.neon --source src/modules/forum/master --destination htdocs/modules/forum/master --title "SilverStripe forum module trunk API Docs"
...
nice $APIGEN_BIN --config conf/apigen/apigen.neon --source src/modules/mssql/master --destination htdocs/modules/mssql/master --title "SilverStripe mssql module trunk API Docs"
...
nice $APIGEN_BIN --config conf/apigen/apigen.neon --source src/modules/multiform/master --destination htdocs/modules/multiform/master --title "SilverStripe multiform module trunk API Docs"
...
nice $APIGEN_BIN --config conf/apigen/apigen.neon --source src/modules/postgresql/master --destination htdocs/modules/postgresql/master --title "SilverStripe postgresql module trunk API Docs"
...
nice $APIGEN_BIN --config conf/apigen/apigen.neon --source src/modules/recaptcha/master --destination htdocs/modules/recaptcha/master --title "SilverStripe recaptcha module trunk API Docs"
...
nice $APIGEN_BIN --config conf/apigen/apigen.neon --source src/modules/subsites/master --destination htdocs/modules/subsites/master --title "SilverStripe subsites module trunk API Docs"
...
nice $APIGEN_BIN --config conf/apigen/apigen.neon --source src/modules/sqlite3/master --destination htdocs/modules/sqlite3/master --title "SilverStripe sqlite3 module trunk API Docs"
...
nice $APIGEN_BIN --config conf/apigen/apigen.neon --source src/modules/tagfield/master --destination htdocs/modules/tagfield/master --title "SilverStripe tagfield module trunk API Docs"
...
nice $APIGEN_BIN --config conf/apigen/apigen.neon --source src/modules/userforms/master --destination htdocs/modules/userforms/master --title "SilverStripe userforms module trunk API Docs"
